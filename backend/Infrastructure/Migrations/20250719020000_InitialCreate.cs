        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true),
                    Items_OrderId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Items_Id = table.Column<int>(type: "int", nullable: true),
                    Items_ProductId = table.Column<int>(type: "int", nullable: true),
                    Items_Quantity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
