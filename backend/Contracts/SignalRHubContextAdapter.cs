...
{
    private readonly Microsoft.AspNetCore.SignalR.IHubContext<OrderHub> _hubContext;

    public SignalRHubContextAdapter(Microsoft.AspNetCore.SignalR.IHubContext<OrderHub> hubContext)
    {
